...
It is designed as a *pure consumer* of ProteoFlux results and does **not** perform any preprocessing or statistical computation
itself.

ProteoViewer can be used:
- locally, as a desktop application,
- centrally, as a multi-user web service (e.g. in a core facility),
- or as a standalone Windows executable built with PyInstaller.
...
## Relationship to ProteoFlux

ProteoViewer is a companion application to ProteoFlux, but is developed and released as a
separate repository to keep analysis and visualization concerns strictly separated.
